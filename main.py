...
def creation_contracts(row, formatted_date, ending):
    try:
        if row[11] > 1000:
            if row[38] == 'None':
                filling_data_hourly_rate(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор.docx")
            # Шаблон_трудовой_договор_уборщ_8_часов
            elif row[38] == 'Шаблон_трудовой_договор_уборщ_8_часов':  # 12 часов
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_уборщ_8_часов.docx")
            # Шаблон_трудовой_договор_8_часов_ИТР_подземные
            elif row[38] == 'Шаблон_трудовой_договор_8_часов_ИТР_подземные':  # 12 часов
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_8_часов_ИТР_подземные.docx")
            # Шаблон_трудовой_договор_12_часов
            elif row[38] == 'Шаблон_трудовой_договор_12_часов':  # 12 часов
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_12_часов.docx")
            # Шаблон_трудовой_договор_6_часов
            elif row[38] == 'Шаблон_трудовой_договор_6_часов':  # 6 часов
                filling_data_hourly_rate(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_6_часов.docx")
            # Шаблон_трудовой_договор_7_часов
            elif row[38] == 'Шаблон_трудовой_договор_7_часов':
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_7_часов.docx")
            # Шаблон_трудовой_договор_8_часов_ИТР_контора_вредность_не_норм_7
                ...
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_8_часов_ИТР_контора_вредность_не_норм_7.docx")
            # Шаблон_трудовой_договор_водителя_8_часов
            elif row[38] == 'Шаблон_трудовой_договор_водителя_8_часов':
                record_data_salary(row, formatted_date, ending,"Шаблоны_трудовых_договоров/Шаблон_трудовой_договор_водителя_8_часов.docx")
